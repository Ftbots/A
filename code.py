...
async def settings_menu(event):
    buttons = ReplyInlineMarkup(rows=[
        ...
        KeyboardButtonRow(buttons=[
            KeyboardButtonCallback(text="Check Mega Storage", data=b"check_storage"),
        ])
    ])
...
async def callback_query_handler(event):
    ...
    elif event.data == b'check_storage':
        await event.answer("This feature is not yet implemented.")
